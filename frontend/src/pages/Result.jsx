      ...
      <div className="bg-white rounded-lg px-8 py-6 shadow-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col">
            ...
            <div className="rounded-md border border-gray-300 h-full bg-layer relative overflow-hidden ">
              {/* <img src={assets.people} alt="" className="w-full object-cover" /> */}
              <img
        ...
        {resultImage && (
          <div className="flex justify-center sm:justify-end items-center flex-wrap gap-4 mt-6">
            <button
              className="border text-indigo-600 font-semibold py-2 px-4 rounded-full text-lg hover:scale-105 transition duration-300"
              onClick={() => navigate("/")}
            >
              Try another image
            </button>
