...
import com.ada.removebg.service.RemoveBackgroundService;
...
public class ImageController {
    ...
    public ResponseEntity<?> removeBackground(@RequestParam("file") MultipartFile file,
        ...
        try {
            // The JWT principal identifies the local account charged for processing.
            ...
            // Avoid calling the external processing service when the balance is zero.
            ...
            // The frontend wraps this payload in a data URL for preview and download.
            String base64Image = Base64.getEncoder().encodeToString(imageBytes);

            // Charge only after Clipdrop returns successfully, so API failures do not consume credit.
